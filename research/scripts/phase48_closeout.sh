...
OUT_DIR="runs/phase48_kernelbench_transfer_closeout"
mkdir -p "$OUT_DIR"

SMALL_GROUPS=(
  "verify_phase48_kernelbench_transfer_8b_s0"
  "verify_phase48_kernelbench_transfer_8b_s1"
  "verify_phase48_kernelbench_transfer_8b_s2"
)
...
ALL_GROUPS=(
  ...
  "verify_phase48_kernelbench_transfer_8b_s1"
  "verify_phase48_kernelbench_transfer_8b_s2"
  "verify_phase48_kernelbench_transfer_70b_s0"
  "verify_phase48_kernelbench_transfer_gptoss20b_s0"
)
...
python3 scripts/kernel_transfer_report.py \
  ...
  --run_group "${ALL_GROUPS[4]}" \
  --out_dir "$OUT_DIR"

echo "[phase48] wrote closeout artifacts to $OUT_DIR"
