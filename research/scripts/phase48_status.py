...
SPECS = [
    "data/ablation_phase48_kernelbench_transfer_8b_s0.json",
    "data/ablation_phase48_kernelbench_transfer_8b_s1.json",
    "data/ablation_phase48_kernelbench_transfer_8b_s2.json",
    "data/ablation_phase48_kernelbench_transfer_70b_s0.json",
    "data/ablation_phase48_kernelbench_transfer_gptoss20b_s0.json",
]
            ...
            if not group_dir.exists():
                views.append(
                    RunView(
                        ...
                        complete=False,
                        task_done=0,
                        target=int(spec.get("max_steps", 0)),
                        state="missing",
                    )
                )
                all_complete = False
